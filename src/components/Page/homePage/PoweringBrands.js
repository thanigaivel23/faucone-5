    ...
    return (
        <>
            ...
            <main className='lg:tw-flex tw-relative'>
                ...
                <section className='tw-z-20 md:tw-p-24 tw-text-center md:tw-text-left tw-py-24'>
                    <p className='tw-font-bold tw-text-[#069fce] tw-text-2xl md:tw-text-5xl'>{t('home.power')} {/* <br className='tw-hidden md:tw-inline' /> */} <span className=' tw-tracking-[3px] md:tw-text-5xl tw-font-medium  tw-text-black'>{t('home.brand')}</span></p>
                    <p className='tw-font-medium tw-text-black tw-text-2xl md:tw-text-5xl tw-my-10'> {t('home.create')} {/* <br className='tw-hidden md:tw-inline' /> */}<span className=' tw-tracking-[3px] md:tw-text-5xl tw-font-bold  tw-text-[#069fce]'>{t('home.enterpernur')}</span></p>
                    <p className=' tw-mt-6 tw-text-base sm:tw-text-base tw-px-3 tw-w-[66%] tw-font-PuviMedium'>{t('home.sub_content')}.</p>
