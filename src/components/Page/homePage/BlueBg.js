...
const BlueBg = () => {
    ...
    return (
        <>
            {/*  */}
            <main className='tw-bg-[#059fce] tw-mt-28 tw-text-white tw-py-16 md:tw-px-24 tw-pb-24  lg:tw-flex tw-items-end tw-rounded-3xl tw-border-solid tw-border-2 ' onMouseEnter={() => Counterup()}>

                <section className=''>
                    <p className='tw-text-center lg:tw-text-left tw-text-3xl lg:tw-text-5xl tw-fon '>Made for the <span className='tw-font-medium'>Global</span></p>
                    ...
                    <div className='sm:tw-grid tw-grid-cols-5 sm:tw-mt-10 '>
                        ...
                        <div className='tw-text-center tw-mt-14 sm:tw-mt-5 lg:tw-items-center '>
                            <p className='tw-text-6xl lg:tw-text-left tw-font-medium tw-tracking-wide lg:tw-w-32 '><span id="counter">1500</span>+</p>
                            <br />
                        ...
                        <div className='tw-text-center lg:tw-text-left tw-mt-14 sm:tw-mt-5 lg:tw-items-center tw-pl-3'>
                            <p className='tw-text-6xl tw-font-medium tw-tracking-wide lg:tw-w-32 '><span id="counter1">200</span>+</p>
                            <br />
                            <p className='  lg:tw-text-left tw-text-base'>Startup Built</p>
                        </div>

                        <div className='tw-text-center lg:tw-text-left tw-mt-14 sm:tw-mt-5 lg:tw-items-center tw-pl-8'>
                            <p className='tw-text-6xl tw-font-medium tw-tracking-wide lg:tw-w-32 '><span id="counter2">25</span>+</p>
                            <br />
